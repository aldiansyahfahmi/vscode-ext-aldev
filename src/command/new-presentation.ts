...
export async function newPresentation(context: vscode.ExtensionContext) {
  let generateFolder = vscode.commands.registerCommand("vscode-ext-aldev.newPresentation", async (uri: vscode.Uri) => {
    // Menampilkan form input
    let inputName = await showInputBox("Enter presentation name");
    ...
    vscode.window.showInformationMessage("Presentation created successfully!");
  });
