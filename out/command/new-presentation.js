...
async function newPresentation(context) {
    let generateFolder = vscode.commands.registerCommand("vscode-ext-aldev.newPresentation", async (uri) => {
        // Menampilkan form input
        let inputName = await (0, show_input_box_js_1.showInputBox)("Enter presentation name");
